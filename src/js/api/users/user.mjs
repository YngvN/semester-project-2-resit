...
export async function registerUser(name, email, password) {
    ...
    try {
        ...
        clearLoginData();
        await buildModal(null, "Registration successful! Please log in.", "success"); // Success message for registration
...
export async function loginUser(email, password, rememberMe) {
    ...
    try {
        ...
        await buildModal(null, "Login successful!", "success"); // Success message for login
...
/**
 * Parses API error response and displays it using buildModal
...
function handleAPIError(data, statusCode) {
    ...
    buildModal(null, errorMessage, "error"); // Display error message in modal
...
/**
 * Displays a generic error message using buildModal
 * @param {string} message - Message to display
 * @returns {object} - Standard error response object
 */
function handleError(message) {
    buildModal(null, message, "error"); // Display error message in modal
